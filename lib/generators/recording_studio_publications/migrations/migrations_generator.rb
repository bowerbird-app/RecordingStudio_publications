...
module RecordingStudioPublications
  module Generators
    # Generator to install RecordingStudioPublications migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_publications:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioPublications migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioPublications engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_publications_pages.rb")
