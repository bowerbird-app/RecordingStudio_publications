...
class DocsController < ApplicationController
  ...
  def gem_views
    prefix = "#{RecordingStudioPublications::Engine.root}/"

    @engine_views = Dir.glob(RecordingStudioPublications::Engine.root.join("app/views/recording_studio_publications/**/*.erb").to_s)
      .sort
